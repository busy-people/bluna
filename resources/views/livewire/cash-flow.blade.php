    ...
    <main class="flex-1 overflow-y-auto">
        ...
        <div class="p-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-xl font-semibold">Cash Flow — {{ $periodLabel }}</h1>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-2xl font-bold {{ $netCashFlow >= 0 ? 'text-blue-600' : 'text-orange-600' }}">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        @foreach($expenseByCategory as $cat)
                            ...
                            <div class="p-4 bg-red-50 rounded-lg">
                                <div class="text-sm text-red-700 font-medium">{{ $catName }}</div>
                                <div class="text-lg font-bold text-red-600">Rp{{ number_format($cat->total, 0, ',', '.') }}</div>
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4">
                ...
                <form wire:submit.prevent="save" class="px-6 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        <select wire:model="category" class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500" required>
                            @php
                                $categories = \App\Models\Cashflow::categories();
                    ...
                    <div>
                        ...
                        <input wire:model="amount" type="number" min="0" step="0.01" class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500" required>
                        @error('amount') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Keterangan</label>
                        <textarea wire:model="description" rows="3" class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500" placeholder="Opsional..."></textarea>
